...
class ExtensionTests: XCTestCase {
    ...
    func testDecodingString() {
        let data = Bundle(for: ExtensionTests.self).decode(String.self, from: "DecodableString.json")
        XCTAssertEqual(
            data,
    ...
    func testDecodingDictionary() {
        let data = Bundle(for: ExtensionTests.self).decode([String: Int].self, from: "DecodableDictionary.json")
    ...
    func testBindingOnChange() {
        ...
        XCTAssertEqual(storedValue, "Test", "The storedValue variable should change with the Binding")
    }
